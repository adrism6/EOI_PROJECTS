...
class Mob(pygame.sprite.Sprite):
    def __init__(
        self, game, groups, position, max_speed, acceleration, max_health, color
    ):
        self.groups = groups
        pygame.sprite.Sprite.__init__(self, self.groups)
        self.game = game
...
class BeeNest(Mob):
    def __init__(
        self, game, position, max_health, spawn_frequency, max_population, color
    ):
        super().__init__(
            game,
        ...
        if time_has_passed and room_left:
            ...
            for _ in range(to_spawn):
                Bee(
                    ...
                    + Vector2(
                        uniform(-TILESIZE, TILESIZE), uniform(-TILESIZE, TILESIZE)
                    ),
                    BEE_MAX_SPEED,
                    BEE_ACCELERATION,
                    BEE_HEALTH,
...
class Tower(Mob):
    def __init__(self, game, position):
        ...
        super().__init__(
            game, (game.all_sprites, game.mobs), position, 0, 0, max_health, color
        )
